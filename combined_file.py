...
def process_emails():
    ...
    message_details_csv_file = os.path.join(input_directory, "organized_emails.csv")
    
    mbox = mailbox.mbox("/Users/iandemusis/Desktop/html_zinoviev/combined_emails.txt")
    for message in mbox:
...
if __name__ == "__main__":
    ...
    #for all the emails that seem to be responses to multiple recipients, 
    #there will be another value in the next column which identifies the most likely recipient
    #or the most recent most likely recipient.
